...
share_text: Today I learned bundler can be used without a gemfile.
category: ruby
---
...
You can see [the source on their GitHub repo][bundler-inline]. This becomes espescially interesting not only for small scripts, but also to have small executable files, that behave like a regular executable.
